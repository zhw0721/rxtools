package com.demo.xbdz.myapplication.util;
...
import com.demo.xbdz.myapplication.R;
        ...
        if (ni != null && ni.isConnectedOrConnecting()) {
            ...
            switch (ni.getType()) {//获取当前网络的状态
                case ConnectivityManager.TYPE_WIFI:// wifi的情况下
                    ...
                    ToastUtil.showLong(context, R.string.description_wifi);
                    break;
                case ConnectivityManager.TYPE_MOBILE:
                    ...
                    switch (ni.getSubtype()) {
                        ...
                        case TelephonyManager.NETWORK_TYPE_IDEN:
                            netType = NETWORK_2G;
                            ToastUtil.showLong(context,R.string.description_2g);
                            break;
                        ...
                        case NETWORK_TYPE_TD_SCDMA:
                            netType = NETWORK_3G;
                            ToastUtil.showLong(context,R.string.description_3g);
                            break;
                        case TelephonyManager.NETWORK_TYPE_LTE:

                        case NETWORK_TYPE_IWLAN:
                            netType = NETWORK_4G;
                            ToastUtil.showLong(context, R.string.description_4g);
                            break;
                        default:
                            ...
                            ToastUtil.showLong(context,R.string.description_unknown_network);
                    }
                    break;
                default:
                    netType = 5;
                    ToastUtil.showLong(context,R.string.description_no_network);
            }
